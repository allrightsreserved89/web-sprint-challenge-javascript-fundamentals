...
///Because the nested function is within the scope of the parent function named myFunction.
///Nested functions have the ability to reach outside their scope to utilize data while the opposite is not true.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(zooAnimals){
    var initialValue = 0
    return zooAnimals.reduce((total, animal) => total + animal.population,initialValue
    );
  }
